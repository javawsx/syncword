    ...
    e[n] &&
      ...
      e[n] &&
        (document.querySelector('#job-list').innerHTML +=
          ...
          i +
          '</div>                <div class="mt-4 hstack gap-2">                    <a href="#!" class="btn btn-soft-primary w-100">Apply Job</a>                    <a href="apps-job-details" class="btn btn-soft-success w-100">Overview</a>                </div>            </div>        </div>    </div>')
  }
